...
\midrule
17-01-23 & 1.0 & Added Content\\
18-01-23 & 1.1 & Added Graph\\
\bottomrule
\end{tabularx}
...
\item[\refstepcounter{acnum} \actheacnum \label{ac4}:] More efficient battery.
...
\item[\refstepcounter{acnum} \actheacnum \label{ac7}:] Upgrading encryption algorithm for user login information.
\end{description}
...
\item [\refstepcounter{mnum} \mthemnum \label{mBluetooth}:] Bluetooth Connection Module
\item [\refstepcounter{mnum} \mthemnum \label{mKeyword}:] Keyword Selection Module
\item [\refstepcounter{mnum} \mthemnum \label{mOutput}:] Output Signal Module
\item [\refstepcounter{mnum} \mthemnum \label{mProfile}:] Profile Module
\item [\refstepcounter{mnum} \mthemnum \label{mBattery}:] Battery Status Module
\item [\refstepcounter{mnum} \mthemnum \label{mSound}:] Sound Classification Module
\item [\refstepcounter{mnum} \mthemnum \label{mComm}:] Bluetooth Communication Module
\item [\refstepcounter{mnum} \mthemnum \label{mMicrophone}:] Microphone Module
\end{description}
