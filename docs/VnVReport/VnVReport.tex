...
Given our size of non-functional requirements, we have grouped some of the tests into test types for ease of understanding.
...
\subsection*{Model confusion matrix}
\begin{figure}[]
  \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{confusion_matrix.png}
