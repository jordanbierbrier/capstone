...
\subsection{Changes Due to Functional Requirement Tests}
\begin{itemize}
  \item Add capability to detect sounds at greater distance (>15m)
  \item Update sound detection performance to be more generalizable (i.e. detect sound from different individuals)
\end{itemize}
\subsection{Changes Due to Nonfunctional Requirement Tests}
\begin{itemize}
  \item Add 
\end{itemize}
