...
\begin{table}[H]
    ...
    \tiny
    \begin{tabular}{| p{0.08\textwidth} | p{0.08\textwidth}  | p{0.1\textwidth} | p{0.145\textwidth} | p{0.1\textwidth} | p{0.1\textwidth} | p{0.05\textwidth} | p{0.05\textwidth} | p{0.03\textwidth} |}
    \hline
