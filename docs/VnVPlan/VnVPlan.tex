...
\textbf{Input:} Sound clips in different environments of noise
...
\textbf{Input:} Sound clips of vocals recorded  
...
\textbf{How test will be performed:}  Tester will play same sound at distances \textcolor{red}{ 1-5m away} from device and check if device picks up sound and reacts as determined
