...
\textbf{Input:} Sound recordings containing 4 keywords, in a quiet environment.
					
\textbf{Output:} Device produces 4 haptic feedbacks

\textbf{Test Case Derivation:} Device needs to react once per keyword therefore 4 keywords should give 4 reactions.
					
\textbf{How test will be performed:} Tester will input randomized sound clips into the device and the device will react 4 times for the 4 keywords found in the sound clips.
...
\textbf{Input:} Sound clips in different environments \textcolor{red}{(quiet room, busy library, quiet outdoors and a construction site)}
...
\textbf{Output:} Device produces haptic feedback at the different sound intensities. 

\textbf{Test Case Derivation:} Device should still be capable of producing a reaction even if the input signal is diminished.
					
\textbf{How test will be performed:}  Tester will play the same sound \textcolor{red}{with different intensities (45dB, 50dB, 60dB, 75dB)} at a distance of 0.5m away from device and check if device picks up sound and reacts.
...
\textbf{Input:} Sound clips \textcolor{red}{currently loaded onto device}
...
\textbf{How test will be performed:} Tester will input sound clips into the device while constant background noises are being played i.e with an ambient noise from a car in the background
...
\textbf{Initial State:} Powered on device with chosen classified keywords  \textcolor{red}{"Jordan"} and no input signal 
